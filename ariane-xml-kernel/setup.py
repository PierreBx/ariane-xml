...
setup(
    ...
    packages=['ariane_xml_kernel'],
    package_dir={'ariane_xml_kernel': '.'},
    package_data={
        'ariane_xml_kernel': ['kernelspec/kernel.json']
    },
    install_requires=[
        'ipykernel>=6.0.0',
    ...
    entry_points={
        'console_scripts': [
            'ariane-xml-kernel-install=ariane_xml_kernel.install:main',
        ],
    },
)
