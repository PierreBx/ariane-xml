# ExpoCLI Encryption Module - Quick Start Guide
...
expocli-encrypt export-mapping -c my_config.yaml -o mapping.json
cat mapping.json
```
...
expocli-encrypt encrypt data.xml dev_data.xml -c config.yaml -p dev-password
expocli-encrypt encrypt data.xml test_data.xml -c config.yaml -p test-password
```

## Troubleshooting

### Issue: "ModuleNotFoundError: No module named 'expocli_crypto'"
...
- View CLI help: `expocli-encrypt --help`
- View command-specific help: `expocli-encrypt encrypt --help`
