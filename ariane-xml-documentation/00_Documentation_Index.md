# Ariane-XML Documentation Index

Complete documentation for Ariane-XML - SQL-like query tool for XML files with encryption.
...
```bash
# CLI
ariane-xml                                # Interactive mode
ariane-xml "SELECT name FROM ./data"      # Single query
...
# Encryption
ariane-xml-encrypt encrypt in.xml out.xml -c config.yaml
ariane-xml-encrypt decrypt enc.xml dec.xml -c config.yaml
```
