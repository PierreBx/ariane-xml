# Ariane-XML Quick Start - Jupyter Notebook

Get started with Ariane-XML in Jupyter notebooks for interactive data exploration and analysis.
...
# Navigate to examples/Ariane-XML_Demo.ipynb
```
...
# Open the demo: examples/Ariane-XML_Demo.ipynb
```
...
Check out `examples/Ariane-XML_Demo.ipynb` for:
- Basic queries
- Advanced filtering
- Multi-file queries
- Real-world examples
...
- **Demo Notebook**: `examples/Ariane-XML_Demo.ipynb`
- **Jupyter Docs**: https://jupyter.org/documentation
- **Ariane-XML Full Docs**: See [main README](../README.md)
