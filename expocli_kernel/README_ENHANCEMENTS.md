...
cp expocli_kernel/kernel_enhanced.py expocli_kernel/kernel.py
...
# 4. Open examples/ExpoCLI_Demo.ipynb
...
**Edit `expocli_kernel/__main__.py`:**

```python
if __name__ == '__main__':
    from ipykernel.kernelapp import IPKernelApp
    # Import enhanced version instead
    from .kernel_enhanced import ExpoCLIKernelEnhanced
...
```bash
git checkout expocli_kernel/kernel.py
docker compose restart jupyter
```
...
Open an issue at: https://github.com/PierreBx/ExpoCLI/issues
