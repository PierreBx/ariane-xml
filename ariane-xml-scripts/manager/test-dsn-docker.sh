#!/bin/bash
# Run DSN mode test suite INSIDE Docker container
...
echo "========================================="
echo "Running DSN Mode Test Suite (Docker Mode)"
echo "========================================="
echo ""
...
CONTAINER_TEST_SCRIPT="/app/ariane-xml-tests/dsn_test.sh"
CONTAINER_OUTPUT_FILE="/tmp/ariane-xml-dsn-test-output.log"
CONTAINER_EXIT_FILE="/tmp/ariane-xml-dsn-test-exit.txt"
